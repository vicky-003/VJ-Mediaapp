...
import com.example.social_mediavj.databinding.ActivityDarkModeBinding
...
class DarkModeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // setContentView(R.layout.activity_dark_mode)
        ...
        sharedPreferences = getSharedPreferences("MODE",android.content.Context.MODE_PRIVATE)
        ...
        binding.darkModeSwitch.setOnCheckedChangeListener { compoundButton, state->
            if (nightMode) {
